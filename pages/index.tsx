    ...
    <Fragment>
      ...
      <main className="home">
        ...
        <p>
          ...
          and got interested in making one.
        </p>
        <p>
          I&apos;m currently working as a frontend developer for a startup overseas. I also know full stack development
          and always working on something that can improve my skills and maybe even monetize it. You can find my
          previous works on my page.
        </p>
      </main>
    </Fragment>
  )
