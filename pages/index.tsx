  ...
  return (
    <div className='container mx-auto mt-4 lg:w-1/2 md:w-4/5'>
      ...
      <p className="text-white px-6 mt-4">
        ...
        This is my first job and designated as a mobile software engineer using React Native. Even though I am working on mobile app,
      ...
      <p className="text-white px-6 mt-4">
        ...
        <a className='underline' target="_blank" href="https://drive.google.com/open?id=100xldwTAc4z6zp3ttvDVeTsWTCfyCdt4">Resume (Google Drive)</a>
      </p>
    </div>
  )
}
